...
export interface ServerCard {
   ...
   *
   * Must be the `/v2/` Server Card schema URL under
   * `static.modelcontextprotocol.io/schemas/` (i.e.,
   * `https://static.modelcontextprotocol.io/schemas/v2/server-card.schema.json`).
   * Schema URLs are versioned by the `vN` segment rather than by date; a
   * revision of the Server Card shape publishes a new `vN` family.
   *
   * @format uri
   * @pattern ^https://static\.modelcontextprotocol\.io/schemas/v2/server-card\.schema\.json$
   */
  $schema: string;
